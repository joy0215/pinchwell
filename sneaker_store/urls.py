...
urlpatterns = [
    ...
    path('send_order_confirmation/', views.send_order_confirmation, name='send_order_confirmation'),
    path('inventory/update/<int:pk>/', views.update_inventory, name='update_inventory'),
    path('inventory/edit/<int:inventory_id>/', views.edit_inventory_view, name='edit_inventory'),
    path('dashboard/', views.employee_dashboard, name='employee_dashboard'),
    path('inventory/search/', views.search_product_view, name='search_product'),
    path('edit_inventory/<int:product_id>/', views.edit_product_stock_view, name='edit_inventory'),
    path('inventory/alert/', views.inventory_alert, name='inventory_alert'),
